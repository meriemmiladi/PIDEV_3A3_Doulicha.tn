...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 02 mars 2023 à 18:22
...
(606, 2, 53, '2023-03-10', '2023-03-20', 2, 5000, '+21629599189');
...
(1, 'miladi', 'mariem', 'm@m.m', 'mm', 'client', 'actif'),
(2, 'aaaaa', 'qqqqq', 's@m.m', 'ss', 'client', 'actif');
...
--
ALTER TABLE `logement`
  MODIFY `ID_logement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `reservation_logement`
  MODIFY `ID_reservation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=607;
