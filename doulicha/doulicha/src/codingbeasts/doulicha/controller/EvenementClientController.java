        ...
        int row = 1, cl =0;
            try{
                for(evenement eve : ev ){
                    ...
                    loader.setLocation(getClass().getResource("/codingbeasts/doulicha/view/detailEvenement.fxml"));
   ...
   /* DetailEvenementController cp = loader.getController();
    ...
    private void jeparticipe(ActionEvent event) {
        ...
        evenement ev= new evenement();
           ...
           FXMLLoader loader = new FXMLLoader ();
                            loader.setLocation(getClass().getResource("/codingbeasts/doulicha/view/ajoutParticipation.fxml"));
                            try {
                                loader.load();
                            } catch (IOException ex) {
                                Logger.getLogger(EvenementClientController.class.getName()).log(Level.SEVERE, null, ex);
